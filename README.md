...
* **Phân khúc RFM (Recency, Frequency, Monetary)**: Tính toán điểm RFM để phân nhóm khách hàng (ví dụ: *At Risk*, *Loyal Customers*, *New Customers*), giúp doanh nghiệp thấu hiểu sâu sắc từng phân khúc hành vi.
